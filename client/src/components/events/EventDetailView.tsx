    ...
    <div className="space-y-5">
      ...
      {event.imageUrl ? (
        ...
        <div className="w-full h-28 rounded-xl border border-gray-200 bg-gray-100 flex items-center justify-center">
          <p className="text-sm text-gray-400">לא סופקה תמונה</p>
        </div>
      )}
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="bg-gray-50 rounded-lg p-3 text-center">
          <p className="text-xs text-gray-500 mb-1">ציון נזק</p>
        ...
        <div className="bg-gray-50 rounded-lg p-3 text-center">
          <p className="text-xs text-gray-500 mb-1">מכפיל גיאוגרפי</p>
          <p className="text-2xl font-bold text-gray-900">
            ×{event.gisDetails?.geoMultiplier?.toFixed(2) ?? '—'}
          </p>
          <p className="text-xs text-gray-400 mt-0.5">גורם GIS</p>
        </div>
        ...
        <div>
          ...
          {event.gisStatus === 'pending' && (
            <div className="flex items-center gap-2 bg-blue-50 border border-blue-200 rounded-lg px-3 py-2 mb-2">
              ...
              <p className="text-xs text-blue-700 font-medium">ניתוח GIS בתהליך — הציונים יתעדכנו אוטומטית...</p>
            </div>
          )}
      ...
      {event.history && event.history.length > 0 && (
        <div>
          <h4 className="text-sm font-semibold text-gray-700 mb-2">היסטוריית סטטוס</h4>
