...
import { ArrowUpDown, ArrowUp, ArrowDown, Eye, EyeOff, MapPin, Calendar } from 'lucide-react';
      ...
      <table className="w-full border-collapse">
        <thead>
          <tr className="border-b border-gray-200">
            ...
            <th
              className={`${thClass} cursor-pointer hover:bg-gray-100`}
              onClick={() => handleSort('damageScore')}
            >
              ...
              >
                <td className={tdClass}>
                  <div className="flex items-start gap-1.5">
                    ...
                    <div>
                      <p className="font-medium text-gray-900 text-xs">{event.location.address}</p>
                    ...
                    <div className="w-16 h-1.5 bg-gray-200 rounded-full overflow-hidden">
                      <div
                        className={`h-full rounded-full ${
                          event.priorityScore >= 7.5
                            ? 'bg-red-500'
                            : event.priorityScore >= 5.0
                            ? 'bg-orange-500'
                            : 'bg-green-500'
                        }`}
                ...
                <td className={tdClass}>
                  {onUpdateStatus ? (
                    <select
                      ...
                      className={`text-xs font-medium rounded-full px-2 py-1 border cursor-pointer focus:outline-none focus:ring-1 focus:ring-blue-400 ${
